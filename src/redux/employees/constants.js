...
export const ADD_OR_EDIT_EMPLOYEE_ERROR = 'ADD_OR_EDIT_EMPLOYEE_ERROR';
export const ADD_OR_EDIT_EMPLOYEE_PENDING = 'ADD_OR_EDIT_EMPLOYEE_PENDING';
export const ADD_OR_EDIT_EMPLOYEE_SUCCESS = 'ADD_OR_EDIT_EMPLOYEE_SUCCESS';
